...
int main (int argc, char ** argv) {
  ...
  myMeshing->setCoordinates(SpaceDimension,NumberOfNodes,Coordinates,"CARTESIAN",med_xc::MED_FULL_INTERLACE);
  ...
  myMeshing->setNumberOfTypes(NumberOfFacesTypes,MED_EN::MED_FACE);
  myMeshing->setTypes(FacesTypes,MED_EN::MED_FACE);
  myMeshing->setNumberOfElements(NumberOfFacesElements,MED_EN::MED_FACE);
  ...
  myMeshing->setConnectivity(MED_EN::MED_FACE,MED_TRIA3,ConnectivityTria);
  ...
  myMeshing->setConnectivity(MED_EN::MED_FACE,MED_QUAD4,ConnectivityQua);
  ...
  // Cell :
  {
    ...
    myGroup->setNumberOfElements(myNumberOfElements);
    const int index[3+1] = {1,5,6,8} ; //Número de tipos+1
