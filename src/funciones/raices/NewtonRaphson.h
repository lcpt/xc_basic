...
#include "xc_basic/src/matrices/m_func.h"
#include "xc_basic/src/matrices/m_int.h"
#include "xc_basic/src/matrices/solvers/solver_lu.h"
#include "xc_basic/src/funciones/op_dif/op_dif.h"
#include "xc_basic/src/funciones/extremos/extremo.h"
...
template<class MF>
class Funcion_g: public Funcion_f<MF>
  {
    const m_double &x;
    const m_double &dx;
  public:
    Funcion_g(const MF &F_,const m_double &x_,const m_double &dx_)
      : Funcion_f<MF>(F_),x(x_),dx(dx_) {}
    inline double operator()(const double &lambda) const
      { return Funcion_f<MF>::operator()(x+lambda*dx); }
  };
