...
BaseRefCaja::BaseRefCaja(const ProtoMatrix &mat,const size_t &f1,const size_t &c1)
...
//! @brief Constructor.
BaseRefCaja::BaseRefCaja(const ProtoMatrix &mat,const size_t &f1,const size_t &c1,const size_t &f2,const size_t &c2)
  : ProtoMatrix(std::max(f2-f1+1,size_t(0)),std::max(c2-c1+1,size_t(0))), offset_f(f1-1),offset_c(c1-1)
  {}

//! @brief Constructor.
BaseRefCaja::BaseRefCaja(const ProtoMatrix &mat,const RangoIndice &row_range,const RangoIndice &column_range)
...
BaseRefCaja::BaseRefCaja(const ProtoMatrix &mat,const RangoIndice &row_range,const size_t &col)
  : ProtoMatrix(row_range.Size(),1), offset_f(row_range.Offset()),offset_c(col-1)
  {}

//! @brief Row alone constructor.
BaseRefCaja::BaseRefCaja(const ProtoMatrix &mat,const size_t &iRow,const RangoIndice &column_range)
