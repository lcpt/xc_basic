...
//----------------------------------------------------------------------------
//vtkDblArrowSource.cc

#include "vtkDblArrowSource.h"
...
vtkCxxRevisionMacro(vtkDblArrowSource, "$Revision: 1.7 $")
vtkStandardNewMacro(vtkDblArrowSource)

vtkDblArrowSource::vtkDblArrowSource(void)
  {
...
int vtkDblArrowSource::RequestData(vtkInformation *vtkNotUsed(request), vtkInformationVector **vtkNotUsed(inputVector), vtkInformationVector *outputVector)
  {
    // get the info object
...
void vtkDblArrowSource::PrintSelf(ostream& os, vtkIndent indent)
  {
