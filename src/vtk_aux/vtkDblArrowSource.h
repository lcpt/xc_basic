...
// .NAME vtkDblArrowSource - Appends a cylinder to a cone to form an arrow.
// .SECTION Description
// vtkDblArrowSource was intended to be used as the source for a glyph.
...
#ifndef __vtkDblArrowSource_h
#define __vtkDblArrowSource_h

#include "vtkPolyDataAlgorithm.h"

class VTK_GRAPHICS_EXPORT vtkDblArrowSource : public vtkPolyDataAlgorithm
{
public:
  // Description
  // Construct cone with angle of 45 degrees.
  static vtkDblArrowSource *New();

  vtkTypeRevisionMacro(vtkDblArrowSource,vtkPolyDataAlgorithm);
...
private:
  vtkDblArrowSource(const vtkDblArrowSource&); // Not implemented.
  void operator=(const vtkDblArrowSource&); // Not implemented.
};
